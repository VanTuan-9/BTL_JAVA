...
public class Menu {
    ...
    public static void SaveWareHouseData(KhoHang khoHang,HoaDon hoaDon)
    {
        ...
        try {
            FileWriter fileWriter = new FileWriter("C:\\Java_YenLinh\\BTL\\KhoHang.txt");
    ...
    {
        try {
            FileWriter fileWriter = new FileWriter("C:\\Java_YenLinh\\BTL\\KHThanThiet.txt");
            BufferedWriter bufferedWriter = new BufferedWriter(fileWriter);
            for (int i = 0; i < khachHangs.size(); i++) {
        ...
        while (true)
        {
            ...
            switch (choce)
            {
                case "1":
                    ...
                    try {
                        FileReader fileReader = new FileReader("C:\\Java_YenLinh\\BTL\\KHThanThiet.txt");
